...
import com.example.androidqimo234.ui.me.calender.weigrt.CalendarView;
...
//        });
    ...
    public void multiChoose(View view) {
        startActivity(new Intent(CalendarActivity.this, com.example.androidqimo234.activity.MultiChooseActivity.class));
    }
}
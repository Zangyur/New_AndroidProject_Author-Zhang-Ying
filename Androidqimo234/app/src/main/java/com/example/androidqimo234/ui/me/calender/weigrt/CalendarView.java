...
import com.example.androidqimo234.ui.me.calender.listener.OnMultiChooseListener;
import com.example.androidqimo234.ui.me.calender.listener.OnPagerChangeListener;
import com.example.androidqimo234.ui.me.calender.listener.OnSingleChooseListener;
...
//        initDate=new int[]{2021,12};
//        mAttrsBean.setSingleDate(initDate);
    ...
    public void init() {
        ...
        currentPosition = CalendarUtil.dateToPosition(initDate[0], initDate[1], startDate[0],
                startDate[1]);
//        lastClickDate[0] = currentPosition;
//        lastClickDate[1] = initDate[2];
//
//        setChooseDate(initDate[2], true,currentPosition);//因为有默认选中日期，所以需要此操作
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int calendarHeight;
        if (getAdapter() != null) {
            com.example.androidqimo234.ui.me.calender.weigrt.MonthView view = (com.example.androidqimo234.ui.me.calender.weigrt.MonthView) getChildAt(0);
            if (view != null) {
    ...
    private void refreshMonthView(int position) {
        com.example.androidqimo234.ui.me.calender.weigrt.MonthView monthView = calendarPagerAdapter.getViews().get(position);
